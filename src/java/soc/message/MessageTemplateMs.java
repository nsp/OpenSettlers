 ...
 *   public static PotentialSettlements parseDataStr(String[] s)
 *   {
 ...
 *           sett[i-1] = s[i];
 *
 *       return new PotentialSettlements(ga, sett);
 *   }
 *</code>
 *<P>
 * For notes on the section you must add to {@link Message#toMsg(String)},
 * see {@link MessageMulti}.
 *
 * @author Jeremy D Monin <jeremy@nand.net>
 */
public abstract class MessageTemplateMs extends MessageMulti
{
    private static final long serialVersionUID = 8012139477022533001L;
     ...
     */
    protected MessageTemplateMs(int id, String ga, String[] parr)
    {
        messageType = id;
        game = ga;
        pa = parr;
