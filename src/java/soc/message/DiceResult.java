 ...
 */
public class DiceResult extends MessageTemplate1i
{
     ...
     */
    public DiceResult(String ga, int dr)
    {
     ...
     */
    public static DiceResult parseDataStr(String s)
    {
