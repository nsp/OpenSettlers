 ...
 */
public class DevCardCount extends Message
{
     ...
     */
    public DevCardCount(String ga, int nd)
    {
     ...
     */
    public static DevCardCount parseDataStr(String s)
    {
    ...
    {
        return "DevCardCount:game=" + game + "|numDevCards=" + numDevCards;
    }
}
