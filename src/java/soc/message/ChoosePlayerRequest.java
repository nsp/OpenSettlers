 ...
 */
public class ChoosePlayerRequest extends Message
{
    private static final long serialVersionUID = -7515847915515486585L;
     ...
     */
    public ChoosePlayerRequest(String ga, boolean[] ch)
    {
     ...
     */
    public static ChoosePlayerRequest parseDataStr(String s)
    {
        ...
        return new ChoosePlayerRequest(ga, ch);
    }
    ...
    {
        String mes = "ChoosePlayerRequest:game=" + game + "|choices=" + choices[0];
