 ...
 */
public class UpdateRobotParams extends Message
{
     ...
     */
    public UpdateRobotParams(RobotParameters par)
    {
     ...
     * @return the command string
     */
    public static String toCmd(RobotParameters par)
    {
     ...
     */
    public static UpdateRobotParams parseDataStr(String s)
    {
        ...
        return new UpdateRobotParams(new RobotParameters(mgl, me, ebf, af, laf, dcm, tm, st, tf));
    }
    ...
    {
        return "UpdateRobotParams:params=" + params;
    }
}
