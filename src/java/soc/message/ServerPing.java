 ...
 */
public class ServerPing extends Message
{
     ...
     */
    public static ServerPing parseDataStr(String s)
    {
        return new ServerPing(Integer.parseInt(s));
    }
    ...
    {
        return "ServerPing:sleepTime=" + sleepTime;
    }
}
