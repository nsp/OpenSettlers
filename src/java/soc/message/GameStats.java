 ...
 */
public class GameStats extends Message
{
    private static final long serialVersionUID = -2216691679303670219L;
    ...
    /**
     * The scores; always indexed 0 to {@link soc.game.Game#maxPlayers} - 1,
     ...
     *   {@link soc.game.Game#maxPlayers} - 1,
     *   regardless of number of players in the game
     * @param rb  where robots are sitting; indexed same as scores
     */
    public GameStats(String ga, int[] sc, boolean[] rb)
    {
     ...
     */
    public static GameStats parseDataStr(String s)
    {
    ...
    {
        StringBuffer text = new StringBuffer("GameStats:game=");
        text.append(game);
