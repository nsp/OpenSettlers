 ...
 * without {@link soc.game.GameOption game options}.
 ...
 * @see GamesWithOptions
 */
public class Games extends Message
{
     ...
     * such as {@link NewGame} and {@link NewGameWithOptions}.
     * Besides those, this marker is not used in any other message types, such as {@link DeleteGame}.
     ...
     */
    public static Games parseDataStr(String s)
    {
        ...
        {
            System.err.println("Games parseDataStr ERROR - " + e);

            return null;
        }

        return new Games((Vector) ga);
    }
    ...
    {
        StringBuffer sb = new StringBuffer("Games:games=");
        if (games != null)
