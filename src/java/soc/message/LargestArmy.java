 ...
 */
public class LargestArmy extends Message
{
     ...
     */
    public LargestArmy(String ga, int pn)
    {
     ...
     */
    public static LargestArmy parseDataStr(String s)
    {
    ...
    {
        return "LargestArmy:game=" + game + "|playerNumber=" + playerNumber;
    }
}
