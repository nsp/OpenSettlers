 ...
 */
public class Members extends Message
{
    private static final long serialVersionUID = 731030422849393972L;
     ...
     */
    public Members(String ch, Vector ml)
    {
        messageType = MEMBERS;
        members = ml;
        channel = ch;
     ...
     */
    public static Members parseDataStr(String s)
    {
        String ch;
    ...
    {
        StringBuffer sb = new StringBuffer("Members:channel=");
        sb.append(channel);
        sb.append("|members=");
        if (members != null)
