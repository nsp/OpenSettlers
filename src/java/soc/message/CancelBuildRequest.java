 ...
 *      an illegal {@link PutPiece PUTPIECE} (bad building location). Humans can probably
 *      decide a better place to put their road, but robots must cancel
 *      the build request and decide on a new plan. <BR>
 *<P>
 *  This can also be the reply if the client sends an illegal {@link BuildRequest BUILDREQUEST}
 ...
 */
public class CancelBuildRequest extends Message
{
    ...
    /**
     * The type of piece to cancel build, such as {@link soc.game.PlayingPiece#CITY}
     ...
     * @param pt  the type of piece to cancel build, such as {@link soc.game.PlayingPiece#CITY}.
     *          Can also pass -2 for server to reject request to buy a Development Card.
     */
    public CancelBuildRequest(String ga, int pt)
    {
    ...
    /**
     * @return the type of piece to build, such as {@link soc.game.PlayingPiece#CITY}.
     ...
     */
    public static CancelBuildRequest parseDataStr(String s)
    {
        ...
        return new CancelBuildRequest(ga, pt);
    }
    ...
    {
        return "CancelBuildRequest:game=" + game + "|pieceType=" + pieceType;
    }
}
