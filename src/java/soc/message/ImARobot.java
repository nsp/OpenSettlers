 ...
 */
public class ImARobot extends Message
{
    /**
     ...
     * This robot is the original robot, distributed with the OpenSettlers server,
     ...
     * @since 1.1.09
     */
    public static final String RBCLASS_BUILTIN = "soc.robot.RobotBrain";
     ...
     * @since 1.1.09
     */
    public ImARobot(String nn, String rbclass)
    {
     ...
     */
    public static ImARobot parseDataStr(String s)
    {
    ...
    {
        String s = "ImARobot:nickname=" + nickname + "|rbclass=" + rbclass;
