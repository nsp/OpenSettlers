...
import soc.game.DevCardConstants;  // for javadoc's use
 ...
 */
public class DevCard extends Message
{
    ...
    /**
     * The type of development card, like {@link DevCardConstants#ROADS}
     */
     ...
     * @param ct  the type of card, like {@link DevCardConstants#ROADS}
     */
    public DevCard(String ga, int pn, int ac, int ct)
    {
        messageType = DEVCARD;
        game = ga;
        playerNumber = pn;
    ...
    /**
     * @return the card type, like {@link DevCardConstants#ROADS}
     */
     ...
     */
    public static DevCard parseDataStr(String s)
    {
        String ga;
        int pn;
        int ac;
        ...
        return new DevCard(ga, pn, ac, ct);
    }
    ...
    {
        String s = "DevCard:game=" + game + "|playerNum=" + playerNumber + "|actionType=" + actionType + "|cardType=" + cardType;
