 ...
 * needs same username/password options as {@link JoinGame JOINGAME}.
 *<P>
 * Introduced in 1.1.07; check server version against {@link NewGameWithOptions#VERSION_FOR_NEWGAMEWITHOPTIONS}
 * before sending this message.  Older servers should be given {@link JoinGame JOINGAME} instead.
 *<P>
 ...
 * @since 1.1.07
 */
public class NewGameWithOptionsRequest extends MessageTemplateJoinGame
{
    private static final long serialVersionUID = 7767375032901875678L;

    /** won't be null, even if opts is null, due to {@link GameOption#packOptionsToString(Hashtable, boolean)} format. */
     ...
     * @param opts the game options (hashtable of {@link GameOption}), or null;
     *           if null, it probably makes sense to create
     *           a {@link JoinGame} message instead.
     */
    public NewGameWithOptionsRequest(String nn, String pw, String hn, String ga, Hashtable opts)
    {
	super(nn, pw, hn, ga);
        messageType = NEWGAMEWITHOPTIONSREQUEST;
	this.opts = opts;
	optsStr = GameOption.packOptionsToString(opts, false);
    }
     ...
     *             {@link GameOption#packOptionsToString(Hashtable, boolean)}.
     */
    public NewGameWithOptionsRequest(String nn, String pw, String hn, String ga, String optstr)
    {
	super(nn, pw, hn, ga);
        messageType = NEWGAMEWITHOPTIONSREQUEST;
	optsStr = optstr;
	opts = GameOption.parseOptionsToHash(optstr);
    }

    /**
     * @return the game options (hashtable of {@link GameOption}), or null;
    ...
    /**
     * @param opts the game options ({@link GameOption})
     * @return    the command string
     */
    public static String toCmd(String nn, String pw, String hn, String ga, Hashtable opts)
    {
	return toCmd(nn, pw, hn, ga, GameOption.packOptionsToString(opts, false));
    }
     ...
     */
    public static NewGameWithOptionsRequest parseDataStr(String s)
    {
        String nn;
        String pw;
        String hn;
	...
	return new NewGameWithOptionsRequest(nn, pw, hn, ga, optstr);
    }
    ...
    {
        return super.toString("NewGameWithOptionsRequest", "opts=" + optsStr);
    }
}
