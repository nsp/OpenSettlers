 ...
 */
public class PlayerElement extends Message
{
    private static final long serialVersionUID = 4355739399810274987L;
    /**
     * player element types.  CLAY has same value
     * as {@link soc.game.ResourceConstants#CLAY};
     * ORE, SHEEP, WHEAT and WOOD also match ResourceConstants.
     */
     ...
     * during the {@link Game#SPECIAL_BUILDING Special Building Phase}.
     ...
     */
    public PlayerElement(String ga, int pn, int ac, int et, int va)
    {
     ...
     */
    public static PlayerElement parseDataStr(String s)
    {
        String ga;
        int pn;
        int ac;
        ...
        return new PlayerElement(ga, pn, ac, et, va);
    }
    ...
    {
        String s = "PlayerElement:game=" + game + "|playerNum=" + playerNumber + "|actionType=" + actionType + "|elementType=" + elementType + "|value=" + value;
