 ...
 *<UL>
 * HL: The hexes, from {@link Board#getHexLayout()}
 * NL: The dice numbers, from {@link Board#getNumberLayout()}
 * RH: The robber hex, from {@link Board#getRobberHex()}
 * PL: The ports, from {@link Board#getPortsLayout()}
 *</UL>
 * Unlike {@link BoardLayout}, dice numbers here equal the actual rolled numbers.
 * <tt>BoardLayout</tt> required a mapping/unmapping step. 
 *
 * @author Jeremy D Monin <jeremy@nand.net>
 * @see BoardLayout
 * @since 1.1.08
 */
public class BoardLayout2 extends Message
{
    ...
    /**
     * Board layout encoding version, from {@link Board#getBoardEncodingFormat()}.
     */
    ...
    /**
     * Create a BoardLayout2 message
     *
     * @param ga   the name of the game
     * @param bef  the board encoding format number, from {@link Board#getBoardEncodingFormat()}
     ...
     */
    public BoardLayout2(String ga, int bef, Hashtable parts)
    {
     ...
     *
     * @param ga   the name of the game
     * @param bev  the board encoding format number, from {@link Board#getBoardEncodingFormat()}
     * @param hl   the hex layout
     * @param nl   the number layout
     * @param pl   the port layout
     * @param rh   the robber hex
     */
    public BoardLayout2(String ga, int bef, int[] hl, int[] nl, int[] pl, int rh)
    {
        messageType = BOARDLAYOUT2;
        game = ga;
        boardEncodingFormat = bef;
    ...
    /**
     * Game's board {@link Board#getBoardEncodingFormat()} version
     ...
     */
    public static BoardLayout2 parseDataStr(String s)
    {
        String ga; // game name
        ...
        return new BoardLayout2(ga, bef, parts);
    }
    ...
    {
        StringBuffer sb = new StringBuffer("BoardLayout2:game=");
        sb.append(game);
        sb.append("|bef=");
