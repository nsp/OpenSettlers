 ...
 */
public abstract class MessageTemplate3s extends Message
{
    private static final long serialVersionUID = 3348975596265581074L;
     ...
     */
    protected MessageTemplate3s(int id, String ga, String p1, String p2, String p3)
    {
        messageType = id;
        game = ga;
        this.p1 = p1;
