 ...
 *       }
 *
 *        return new SitDown(ga, pn);
 *   }
 *</code>
 *
 * @author Jeremy D Monin <jeremy@nand.net>
 */
public abstract class MessageTemplate1s extends Message
{
    private static final long serialVersionUID = -2787580098582651311L;
     ...
     * @param p   Parameter
     */
    protected MessageTemplate1s(int id, String ga, String p)
    {
        messageType = id;
        game = ga;
        p1 = p;
