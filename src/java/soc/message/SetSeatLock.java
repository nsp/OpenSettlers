 ...
 */
public class SetSeatLock extends Message
{
     ...
     */
    public SetSeatLock(String ga, int pn, boolean st)
    {
     ...
     */
    public static SetSeatLock parseDataStr(String s)
    {
        ...
        return new SetSeatLock(ga, pn, ls);
    }
    ...
    {
        return "SetSeatLock:game=" + game + "|playerNumber=" + playerNumber + "|state=" + state;
    }
}
