 ...
 * @since 1.1.09
 */
public class PlayerElements extends MessageTemplateMi
{
     ...
     * {@link PlayerElement#CLAY}, ORE, SHEEP, WHEAT, {@link PlayerElement#WOOD}.
     */
    public static final int[] NAMED_RESOURCES = {PlayerElement.CLAY, PlayerElement.ORE, PlayerElement.SHEEP, PlayerElement.WHEAT, PlayerElement.WOOD};
    ...
    /**
     * Action type: {@link PlayerElement#SET}, {@link PlayerElement#GAIN}, or {@link PlayerElement#LOSE}
     */
    private int actionType;

    /**
     * Element types, such as {@link PlayerElement#CLAY}, matching
     ...
     * @param ac  the type of action: {@link PlayerElement#SET},
     *             {@link PlayerElement#GAIN}, or {@link PlayerElement#LOSE}
     * @param et  array of the types of element, such as {@link PlayerElement#SETTLEMENTS}
     * @param va  array of the values of each element, corresponding to <tt>et[]</tt>
     * @throws NullPointerException if et null or va null
     */
    public PlayerElements(String ga, int pn, int ac, final int[] et, final int[] va)
    ...
    /**
     * @return the element type array, such as {@link PlayerElement#CLAY}, matching
    ...
    /**
     * Parse the command String array into a PlayerElements message.
     *
     ...
     * pa[5] = value[1]</pre>
     * (etc.)
     * @return    a PlayerElements message, or null if parsing errors
     */
    public static PlayerElements parseDataStr(String[] pa)
    {
        ...
        try
        {
            ...
            return new PlayerElements(ga, playerNumber, actionType, elementTypes, values);
        } catch (Throwable e)
        {
            return null;
        }
