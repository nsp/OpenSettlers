 ...
 */
public class LastSettlement extends Message
{
     ...
     */
    public LastSettlement(String na, int pn, int co)
    {
     ...
     */
    public static LastSettlement parseDataStr(String s)
    {
        ...
        return new LastSettlement(na, pn, co);
    }
    ...
    {
        String s = "LastSettlement:game=" + game + "|playerNumber=" + playerNumber + "|coord=" + Integer.toHexString(coordinates);
