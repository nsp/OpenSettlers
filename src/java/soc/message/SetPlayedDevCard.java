 ...
 */
public class SetPlayedDevCard extends Message
{
    private static final long serialVersionUID = 2035230986016889526L;
     ...
     */
    public SetPlayedDevCard(String ga, int pn, boolean pd)
    {
     ...
     */
    public static SetPlayedDevCard parseDataStr(String s)
    {
        ...
        return new SetPlayedDevCard(ga, pn, pd);
    }
    ...
    {
        return "SetPlayedDevCard:game=" + game + "|playerNumber=" + playerNumber + "|playedDevCard=" + playedDevCard;
    }
}
