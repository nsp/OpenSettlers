...
public class TextMsg extends Message
{
     ...
     */
    public TextMsg(String ch, String nn, String tm)
    {
        messageType = TEXTMSG;
        channel = ch;
        nickname = nn;
     ...
     */
    public static TextMsg parseDataStr(String s)
    {
        String ch;
        String nn;
        String tm;
    ...
    {
        String s = "TextMsg:channel=" + channel + "|nickname=" + nickname + "|text=" + text;
