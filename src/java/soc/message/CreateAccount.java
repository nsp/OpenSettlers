...
public class CreateAccount extends Message
{
     ...
     * @param em  email
     */
    public CreateAccount(String nn, String pw, String hn, String em)
    {
     ...
     */
    public static CreateAccount parseDataStr(String s)
    {
        String nn;
        String pw;
        String hn;
        ...
        return new CreateAccount(nn, pw, hn, em);
    }
    ...
    {
        String s = "CreateAccount:nickname=" + nickname + "|password=" + password + "|host=" + host + "|email=" + email;
