 ...
 * {@link JoinAuth JOINAUTH} or {@link JoinGameAuth JOINGAMEAUTH}),
 * or rejection if client can't join that game (or channel).
 * Also used in {@link soc.client.AccountClient AccountClient}
...
public class StatusMessage extends Message
{
     ...
     *   {@link Message#sep2 SEP2} game name
     *   {@link Message#sep2 SEP2} option keyname with problem
     *   {@link Message#sep2 SEP2} option keyname with problem (if more than one)
     *   ...
     * @see soc.server.SOCServer#handleNEWGAMEWITHOPTIONSREQUEST
     * @since 1.1.07
     */
     ...
     *            may not contain {@link Message#sep2} characters.
     *            This will cause parsing to fail on the remote end.
     */
    public StatusMessage(String st)
    {
        this (0, st);
    }
     ...
     * @param st  the status message text.
     *            If sv is nonzero, you may embed {@link Message#sep2} characters
     *            in your string, and they will be passed on for the receiver to parse.
     * @since 1.1.06
     */
    public StatusMessage(int sv, String st)
    {
    ...
    /**
     * @return the status message text. Is allowed to contain {@link Message#sep2} characters.
     */
     ...
     * If status is nonzero, you may embed {@link Message#sep2} characters
     ...
     */
    public static StatusMessage parseDataStr(String s)
    {
        int sv = 0;
