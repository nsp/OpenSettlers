 ...
 * The server will respond with {@link GameOptionInfo GAMEOPTIONINFO} message(s),
 ...
 * @since 1.1.07
 */
public class GameOptionGetInfos extends Message
{
     ...
     */
    public GameOptionGetInfos(Vector okeys)
    {
        ...
        if (opts == null)
        {
            ...
            try
            {
                ...
                if (o instanceof GameOption)
                    cmd.append(((GameOption) o).optKey);
                else
                    cmd.append((String) o);
     ...
     */
    public static GameOptionGetInfos parseDataStr(String s)
    {
	...
	boolean hasDash = false;
        ...
        {
            System.err.println("GameOptionGetInfos parseDataStr ERROR - " + e);
	...
	if (hasDash)
	{
        ...
        return new GameOptionGetInfos(okey);
    }
    ...
    {
        StringBuffer sb = new StringBuffer("GameOptionGetInfos:options=");
        if (optkeys == null)
            sb.append("-");
        else
