...
public class LeaveGame extends Message
{
     ...
     */
    public LeaveGame(String nn, String hn, String ga)
    {
     ...
     */
    public static LeaveGame parseDataStr(String s)
    {
        String nn; // nickname
        String hn; // host name
        String ga; // game name
    ...
    {
        String s = "LeaveGame:nickname=" + nickname + "|host=" + host + "|game=" + game;
