 ...
 */
public class SitDown extends Message
{
    private static final long serialVersionUID = 2441993259430652928L;
     ...
     */
    public SitDown(String ga, String nk, int pn, boolean rf)
    {
        messageType = SITDOWN;
        game = ga;
        nickname = nk;
     ...
     */
    public static SitDown parseDataStr(String s)
    {
        ...
        return new SitDown(ga, nk, pn, rf);
    }
    ...
    {
        return "SitDown:game=" + game + "|nickname=" + nickname + "|playerNumber=" + playerNumber + "|robotFlag=" + robotFlag;
    }
}
