...
{
    private static final long serialVersionUID = -4250523841070612271L;
     ...
     */
    public static Turn parseDataStr(String s)
    {
    ...
    {
        return "Turn:game=" + game + "|playerNumber=" + playerNumber;
    }
}
