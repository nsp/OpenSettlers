 ...
 */
public class PotentialSettlements extends Message
{
    ...
    /**
     * Create a PotentialSettlements message.
     *
     * @param ga  name of the game
     * @param pn  the player number
     * @param ps  the list of potential settlements
     */
    public PotentialSettlements(String ga, int pn, Vector ps)
    {
    ...
    public static PotentialSettlements parseDataStr(String s)
    {
        ...
        return new PotentialSettlements(ga, pn, ps);
    }
    ...
    {
        String s = "PotentialSettlements:game=" + game + "|playerNum=" + playerNumber + "|list=";
