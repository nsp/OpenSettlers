 ...
 */
public class RollDicePrompt extends Message
{
    private static final long serialVersionUID = -7609803165419825001L;
     ...
     */
    public RollDicePrompt(String ga, int pn)
    {
     ...
     */
    public static RollDicePrompt parseDataStr(String s)
    {
        ...
        return new RollDicePrompt(ga, pn);
    }
    ...
    {
        return "RollDicePrompt:game=" + game + "|playerNumber=" + playerNumber;
    }
