...
public class Join extends Message
{
     ...
     */
    public Join(String nn, String pw, String hn, String ch)
    {
        messageType = JOIN;
        nickname = nn;
        password = pw;
     ...
     */
    public static Join parseDataStr(String s)
    {
        String nn;
        String pw;
        String hn;
    ...
    {
        String s = "Join:nickname=" + nickname + "|password=" + password + "|host=" + host + "|channel=" + channel;
