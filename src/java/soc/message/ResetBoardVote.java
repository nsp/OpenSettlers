 ...
 *<UL>
 * <LI> This message to server is in response to a {@link ResetBoardRequest}
 *      sent earlier this turn to all non-robot clients. (Robots' vote is always Yes.)
 * <LI> Followed by (from server, to all clients) {@link ResetBoardVote} with the same data,
 *      informing all players of this client's vote.
 * <LI> Once voting is complete, server sends to all either a {@link ResetBoardAuth} or
 *      {@link ResetBoardReject} message.
 *</UL>
...
public class ResetBoardVote extends MessageTemplate2i
{
    ...
    /**
     * Parse the command String into a ResetBoardVote message
     *
     * @param s   the String to parse: RESETBOARDVOTE sep game sep2 playernumber sep2 yesno [1 or 0]
     * @return    a ResetBoardVote message, or null if the data is garbled
     */
    public static ResetBoardVote parseDataStr(String s)
    {
        ...
        return new ResetBoardVote(ga, pn, vy != 0);
    }
