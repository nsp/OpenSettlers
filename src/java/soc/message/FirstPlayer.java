 ...
 */
public class FirstPlayer extends Message
{
     ...
     */
    public FirstPlayer(String ga, int pn)
    {
     ...
     */
    public static FirstPlayer parseDataStr(String s)
    {
    ...
    {
        return "FirstPlayer:game=" + game + "|playerNumber=" + playerNumber;
    }
}
