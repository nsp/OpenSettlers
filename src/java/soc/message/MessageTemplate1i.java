 ...
 *       }
 *
 *        return new LongestRoad(ga, pn);
 *   }
 *</code>
 *
 * @author Jeremy D Monin <jeremy@nand.net>
 */
public abstract class MessageTemplate1i extends Message
{
    private static final long serialVersionUID = -6790981481078004352L;
     ...
     * @param p   Parameter
     */
    protected MessageTemplate1i(int id, String ga, int p)
    {
        messageType = id;
        game = ga;
        p1 = p;
