 ...
 */
public abstract class MessageTemplate0 extends Message
{
    private static final long serialVersionUID = -2515212619936040771L;
    /**
     * Name of the game.
     */
     ...
     */
    protected MessageTemplate0(int id, String ga)
    {
        messageType = id;
        game = ga;
    }
    ...
    public static AdminPing parseDataStr(String s)
    {
        return new AdminPing(Integer.parseInt(s));
    }
     */
