 ...
 */
public abstract class MessageTemplate2s extends Message
{
    private static final long serialVersionUID = 3758480572083240811L;
     ...
     */
    protected MessageTemplate2s(int id, String ga, String p1, String p2)
    {
        messageType = id;
        game = ga;
        this.p1 = p1;
