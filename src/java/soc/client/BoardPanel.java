 ...
 * {@link BoardPanel.BoardToolTip#hoverRoadID}.
 * Right-click to build, or use the {@link BuildingPanel}'s buttons.
 *<P>
 ...
 */
public class BoardPanel extends Canvas implements MouseListener, MouseMotionListener
{
     ...
     * and during {@link Game#SPECIAL_BUILDING} phase of the 6-player game.
     *<P>
     ...
     * For tooltip's mode, see {@link BoardPanel.BoardToolTip#hoverMode}.
     */
    private int mode;
     ...
     * Called from {@link PlayerInterface#doLayout()}.
     *
     ...
     * @param hexType hex number, as in {@link Board#getHexLayout()}
    ...
    private final void drawArrow(Graphics g, int pnum, int diceResult)
    {
         ...
         */
        if ((diceResult >= 2) && (gameState != Game.PLAY) && (gameState != Game.SPECIAL_BUILDING))
        {
            if (isScaled)
            {
    ...
    private void drawBoard(Graphics g)
    {
        ...
        {
            drawRobber(g, board.getRobberHex(), (gameState != Game.PLACING_ROBBER));
        }
     ...
     * For {@link soc.game.GameOption#initAllOptions() Game Option "N7"},
     ...
     *
     * @param ptype Piece type to clear, like {@link PlayingPiece#ROAD}, or -1 for robber.
    ...
    public void mouseClicked(MouseEvent evt)
    {
        ...
        if ((hilight != 0) && (player != null))
        {
            ...
            case PLACE_SETTLEMENT:
                ...
                {
                    client.putPiece(game, new Settlement(player, hilight, board));
            ...
            case CONSIDER_LM_SETTLEMENT:
                ...
                {
                    client.considerMove(game, otherPlayer.getName(), new Settlement(otherPlayer, hilight, board));
                    clearModeAndHilight(PlayingPiece.SETTLEMENT);
                }
            ...
            case CONSIDER_LM_ROAD:
                ...
                {
                    client.considerMove(game, otherPlayer.getName(), new Road(otherPlayer, hilight, board));
                    clearModeAndHilight(PlayingPiece.ROAD);
                }
            ...
            case CONSIDER_LM_CITY:
                ...
                {
                    client.considerMove(game, otherPlayer.getName(), new City(otherPlayer, hilight, board));
                    clearModeAndHilight(PlayingPiece.CITY);
                }
            ...
            case CONSIDER_LT_SETTLEMENT:
                ...
                if (otherPlayer.isPotentialSettlement(hilight))
                {
                    client.considerTarget(game, otherPlayer.getName(), new Settlement(otherPlayer, hilight, board));
                    clearModeAndHilight(PlayingPiece.SETTLEMENT);
                }
            ...
            case CONSIDER_LT_ROAD:
                ...
                if (otherPlayer.isPotentialRoad(hilight))
                {
                    client.considerTarget(game, otherPlayer.getName(), new Road(otherPlayer, hilight, board));
                    clearModeAndHilight(PlayingPiece.ROAD);
                }
            ...
            case CONSIDER_LT_CITY:
                ...
                if (otherPlayer.isPotentialCity(hilight))
                {
                    client.considerTarget(game, otherPlayer.getName(), new City(otherPlayer, hilight, board));
                    clearModeAndHilight(PlayingPiece.CITY);
                }
     ...
     * @param hexType  hexType value, as in {@link Board#DESERT_HEX}, {@link Board#WOOD_HEX},
     *                 {@link Board#WATER_HEX}.
     *                 Same value and meaning as those in {@link Board#getHexLayout()}.
    ...
    protected class BoardToolTip
    {
        ...
        /** "ID" of coord as returned by {@link BoardPanel#findNode(int, int) findNode}, findEdge, findHex */
        private int hoverID;
         ...
         * Does not affect the "hilight" variable used by BoardPanel during
                ...
                if (p != null)
                {
                    ...
                    if (playerIsCurrent)
                    {
                        ...
                        if (modeAllowsHoverPieces
                            ...
                            && player.getResources().contains(Game.SETTLEMENT_SET))
                    ...
                    default:
                        {
                            ...
                            if ((htype >= Board.MISC_PORT_HEX) && (htype <= Board.WOOD_PORT_HEX))
                            {
                                portDesc = portDescForType(htype - (Board.MISC_PORT_HEX - Board.MISC_PORT));
                            }
                            if (portDesc != null)
                            {
                                sb.append(portDesc);
         ...
         * @param portType Port type, as from {@link Board#getPortTypeFromNodeCoord(int)}.
         *           Should be in range {@link Board#MISC_PORT} to {@link Board#WOOD_PORT}.
    ...
    /** our parent boardpanel */
       ...
       * 
       * @param buildType piece type (PlayingPiece.ROAD, CITY, SETTLEMENT)
       ...
       *
       * @param ptype Piece type, like {@link PlayingPiece#ROAD}
       */
      void tryBuild(int ptype)
      {
          ...
          case PlayingPiece.ROAD:
              ...
              if (canBuild && (isInitialPlacement || wantsCancel))
                  playerInterface.getClient().putPiece(game, new Road(player, buildLoc, board));
          ...
          case PlayingPiece.SETTLEMENT:
              ...
              if (canBuild && (isInitialPlacement || wantsCancel))
              {
                  playerInterface.getClient().putPiece(game, new Settlement(player, buildLoc, board));
                  if (isInitialPlacement)
          ...
          case PlayingPiece.CITY:
              ...
              if (canBuild && (isInitialPlacement || wantsCancel))
                  playerInterface.getClient().putPiece(game, new City(player, buildLoc, board));
     ...
     * @author Jeremy D Monin <jeremy@nand.net>
     */
    /* package-access */ static class ResourceTradeAllMenu extends HandPanel.ResourceTradePopupMenu
    {
        /**
         * 
         */
            ...
            throws IllegalStateException
        {
          ...
          for (int i = 0; i < 5; ++i)
          {
              tradeFromTypes[i] = new HandPanel.ResourceTradeTypeMenu(hp, i+1, true);
    ...
    protected class BoardPanelSendBuildTask extends java.util.TimerTask
    {
         ...
         * 
         * @param coord Board coordinates, as used in PutPiece message. Does not accept -1 for road edge 0x00.
         * @param ptype Piece type, as used in PlayingPiece / PutPiece
         */
        ...
        public void sendOnceFromClientIfCurrentPlayer()
        {
            ...
            case PlayingPiece.SETTLEMENT:
                if (player.isPotentialSettlement(buildLoc))
                    client.putPiece(game, new Settlement(player, buildLoc, board));
                break;
            case PlayingPiece.CITY:
