 ...
 */
class DiscardDialog extends Dialog implements ActionListener, MouseListener
{
    ...
    public void setVisible(boolean b)
    {
        if (b)
        {
             ...
             * set initial values
             */
            Player player = playerInterface.getGame().getPlayer(playerInterface.getClient().getNickname());
            ResourceSet resources = player.getResources();
            keep[0].setIntValue(resources.getAmount(ResourceConstants.CLAY));
            keep[1].setIntValue(resources.getAmount(ResourceConstants.ORE));
            keep[2].setIntValue(resources.getAmount(ResourceConstants.SHEEP));
            keep[3].setIntValue(resources.getAmount(ResourceConstants.WHEAT));
            keep[4].setIntValue(resources.getAmount(ResourceConstants.WOOD));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            ResourceSet rsrcs = new ResourceSet(disc[0].getIntValue(), disc[1].getIntValue(), disc[2].getIntValue(), disc[3].getIntValue(), disc[4].getIntValue(), 0);
