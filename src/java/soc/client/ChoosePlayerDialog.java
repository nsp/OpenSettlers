 ...
 */
class ChoosePlayerDialog extends Dialog implements ActionListener
{
     ...
     * @param p DOCUMENT ME!
     */
    public ChoosePlayerDialog(PlayerInterface plInt, int num, int[] p)
    {
        ...
        {
            Player pl = ga.getPlayer(players[i]);            
            ...
            HandPanel ph = pi.getPlayerHandPanel(players[i]);
