 ...
 */
class DiscoveryDialog extends Dialog implements ActionListener, ColorSquareListener
{
    ...
    /**
     * Creates a new DiscoveryDialog object.
     *
     * @param pi  the interface that this panel is a part of
     */
    public DiscoveryDialog(PlayerInterface pi)
    {
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (target == doneBut)
        {
            ...
            if (sum == 2)
            {
                ResourceSet resources = new ResourceSet(rsrcCnt);
