 ...
 */
public class AccountClient extends Applet implements Runnable, ActionListener
{
    ...
    /**
     * Create a AccountClient connecting to localhost port 8880
     */
     ...
     * @param p  port
     */
    public AccountClient(String h, int p)
    {
        host = h;
        port = p;
    }
    ...
    {
        char pwchar = PlayerClient.isJavaOnOSX ? '\u2022' : '*';
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if (target == submit)
        {
            ...
            else if (!submitLock)
            {
                ...
                put(CreateAccount.toCmd(nickname, password, host, emailAddress));
            }
        }
    }
    ...
    public void treat(Message mes)
    {
        ...
        {
            System.out.println("AccountClient treat ERROR - " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    {
        return "AccountClient 0.1 by Robert S. Thomas.";
    }
    ...
    {
        System.err.println("usage: java soc.client.AccountClient <host> <port>");
    }
    ...
    public static void main(String[] args)
    {
        ...
        Frame frame = new Frame("AccountClient");
