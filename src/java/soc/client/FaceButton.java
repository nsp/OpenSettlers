 ...
 */
public class FaceButton extends Canvas
{
    ...
    private int pNumber;
    private Game game;
    private PlayerInterface pi;  // For callbacks (stack-trace print)
     ...
     *
     * @see soc.client.PlayerInterface#makeGhostColor(Color)
     */
    ...
    /**
     * create a new FaceButton, for a player's handpanel (standard mode). Face id DEFAULT_FACE.
     *
     * @param pi  the interface that this button is attached to
     * @param pn  the number of the player that owns this button. Must be in range 0 to ({@link Game#maxPlayers} - 1).
     *
     * @throws IllegalArgumentException if pn is < -1 or >= Game.MAXPLAYERS.
     */
    public FaceButton(PlayerInterface pi, int pn)
    ...
    /**
     * create a new FaceButton, for the FaceChooserFrame (bordered mode)
     *
     ...
     */
    public FaceButton(PlayerInterface pi, FaceChooserFrame fcf, int faceId)
    {
    ...
    /**
     * implement creation of a new FaceButton (common to both modes)
     *
     * @param pi  the interface that this button is attached to
     ...
     *
     * @throws IllegalArgumentException if pn is < -1 or >= {@link Game#maxPlayers},
     *           or if <tt>pi.getGame()</tt> is null.
     */
    protected FaceButton(PlayerInterface pi, int pn, Color bgColor, int width)
        throws IllegalArgumentException
    {
        super();
    ...
    private void paintBorder(Graphics g, boolean showNotClear)
    {
        ...
        if (showNotClear)
        {
            if (hilightBorderColor == null)
                hilightBorderColor = PlayerInterface.makeGhostColor(getBackground());
    ...
    private class MyMouseAdapter extends MouseAdapter
    {
        ...
        public void mouseClicked(MouseEvent evt)
        {
             ...
             * game: Standard mode (within HandPanel)
             */
            if (faceChooser != null)
            {
        ...
        implements java.awt.event.ActionListener
    {
        ...
        public FaceButtonPopupMenu(FaceButton fbutton)
        {
          super ("OpenSettlers");
          fb = fbutton;
