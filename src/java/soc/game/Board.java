...
public class Board implements Serializable, Cloneable
{
     ...
     * See also Player.initLegalAndPotentialSettlements().
     */
    protected Hashtable nodesOnBoard;

    /**
     * Create a new Settlers of Catan Board.
     * @param gameOpts  if game has options, hashtable of {@link GameOption}; otherwise null.
     ...
     * @param opts {@link GameOption Game options}, which may affect
    ...
    public void makeNewBoard(Hashtable opts)
    {
        ...
        GameOption opt_breakClumps = (opts != null ? (GameOption)opts.get("BC") : null);
    ...
    private final void makeNewBoard_placeHexes
        (int[] landHex, final int[] numPath, final int[] number, GameOption optBC)
    {
     ...
     */
    private void makeNewBoard_shufflePorts(int[] portHex, GameOption opt_breakClumps)
     ...
     * 
     * @param nodeCoord Location coordinate (as returned by BoardPanel.findNode)
     ...
     * 
     * @param edgeCoord Location coordinate (as returned by BoardPanel.findEdge) 
     * @return road or null
     */
