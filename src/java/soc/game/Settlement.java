...
public class Settlement extends PlayingPiece
{
     ...
     */
    public Settlement(Player pl, int co, Board board)
        throws IllegalArgumentException
    {
        super(PlayingPiece.SETTLEMENT, pl, co, board);
    }

    /**
     * @return the hexes touching this settlement, same format as {@link Board#getAdjacentHexesToNode(int)}
     */
