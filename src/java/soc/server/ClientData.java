...
public class ClientData
{
     ...
     * Please synchronize on {@link GameList#takeMonitor()} / releaseMonitor.
     * @since 1.1.06
     */
     ...
     * not {@link soc.message.ImARobot#RBCLASS_BUILTIN}.
     * @since 1.1.09
     */
     ...
     * the {@link Message#SERVERPING} message.
     * @since 1.1.08
     */
    ...
    /**
     * Copy the client's win-loss record from another ClientData.
     * ({@link #getWins()}, {@link #getLosses()}).
     *
     * @param source Copy from here
     * @since 1.1.08
     */
    public void copyClientPlayerStats(ClientData source)
    {
        wins = source.wins;
    ...
    private static class SOCCDCliVersionTask extends TimerTask
    {
        ...
        public SOCCDCliVersionTask (SOCServer sr, ClientData cd, StringConnection con)
        {
            srv = sr;
            cliData = cd;
            cliConn = con;
