...
public class ChannelList
{
    ...
    {
        D.ebugPrintln("ChannelList : TAKE MONITOR");
    ...
    {
        D.ebugPrintln("ChannelList : RELEASE MONITOR");
        inUse = false;
        this.notify();
    }
    ...
    {
        D.ebugPrintln("ChannelList : TAKE MONITOR FOR " + channel);
    ...
    {
        D.ebugPrintln("ChannelList : RELEASE MONITOR FOR " + channel);
    ...
    {
        D.ebugPrintln("ChannelList : deleteChannel(" + chName + ")");
